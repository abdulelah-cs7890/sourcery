    ...
    <main className="mx-auto max-w-6xl px-6 py-20 sm:py-28 flex justify-center">
      <div className="w-full max-w-md">
        <div className="relative rounded-3xl border border-[var(--color-border)] bg-[radial-gradient(ellipse_at_top,#0d3a2d_0%,#08090c_70%)] p-8 sm:p-10 text-center">
          ...
          <Link
            href="/signin"
            className="inline-flex items-center justify-center rounded-full border border-[var(--color-border)] bg-[var(--color-panel)] text-[var(--color-text)] px-5 py-2.5 text-sm font-medium hover:border-[var(--color-border-strong)] transition"
          >
            ← Back to sign in
          </Link>
        </div>
